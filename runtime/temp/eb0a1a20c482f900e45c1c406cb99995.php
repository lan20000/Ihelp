<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:37:"./views/home/mobile/index\index.phtml";i:1559104403;s:72:"C:\phpStudy\PHPTutorial\WWW\public\views\home\mobile\common\footer.phtml";i:1555171596;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
	<head>
                ...
                <li>
                    <a href="/home/task/detail/id/<?php echo $task['id']; ?>.html">
                        ...
                        <div class="task-list-title-silver">
                            <div class="task-list-title"><?php echo $task['title']; if($task['top_end_time']>$task['take_time']): ?>
                            <span style="margin-left: 4px";><img alt="" src="/static/home/mobile/images/zhiding.png"></span>
                            <?php endif; ?>
                            </div>
                        ...
                        <span><?php echo $task['join_num']; ?>人已赚</span>
                        <span class="task-list-remain-num">剩余<?php echo $task['ticket_num']-$task['join_num']; ?>份</span>
                        <div class="task-list-gold-silver"><span class="task-list-prefix"><?php echo $task['typename']; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;<span class="task-list-prefix"><?php echo $task['keywords']; ?></span></div>
        ...
        <div class="paging">
            ...
            <span class="paging-num-total">
					<select name="page" class="paging-selct">
                        <?php $__FOR_START_17678__=1;$__FOR_END_17678__=$pageCount+1;for($i=$__FOR_START_17678__;$i < $__FOR_END_17678__;$i+=1){ ?>
