...
function setNum(id){
    ...
    bootbox.prompt({
        ...
        callback: function (result) {
            ...
            Common.ApiPost('/home/mytask/setNum', {id: id, hour: result}, function(res){
                if(res.type == "success"){
                   $("#setNum" + id).addClass("ajax-ok").html("已加量");
                    message(res.message,'',res.type);
                }else{
                    message(res.message,res.redirect,res.type);
                }
...
function setTime(id){
	if ($("#setTime" + id).hasClass("ajax-ok")) {
        return;
    }
    ...
    bootbox.prompt({
        ...
        callback: function (result) {
            ...
            Common.ApiPost('/home/mytask/setTime', {id: id, day: result}, function(res){
                if(res.type == "success"){
                   $("#setTime" + id).addClass("ajax-ok").html("已加时");
                    message(res.message,'',res.type);
                }else{
                    message(res.message,res.redirect,res.type);
                }
...
function taskStop(id) {
    if ($("#taskStop" + id).hasClass("ajax-ok")) {
        return;
    }
    ...
    $(document).dialog({
        ...
        onClickConfirmBtn: function(){
            Common.loading.show();
            $.post('/home/mytask/taskStop.html', { id: id }, function(res) {
                Common.loading.hide();
                if (res.type == "success") {
                    $("#taskStop" + id).addClass("ajax-ok").html("暂停中");
...
function outStop(id) {
    if ($("#outStop" + id).hasClass("ajax-ok")) {
        return;
    }
    ...
    $(document).dialog({
        ...
        onClickConfirmBtn: function(){
            Common.loading.show();
            $.post('/home/mytask/outStop.html', { id: id }, function(res) {
                Common.loading.hide();
                if (res.type == "success") {
                	window.location.reload();
                    return;
